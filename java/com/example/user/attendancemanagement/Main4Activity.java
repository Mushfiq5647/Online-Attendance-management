...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main4Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        ...
                        break;
                    case R.id.developer:
                        Intent intent3 = new Intent(Main4Activity.this,developer.class);
        ...
        final String[] semester = { "CSE1203", "CSE1202", "CSE1203", "CSE1204","CSE1205","CSE1206","CSE1207","CSE1208"};
