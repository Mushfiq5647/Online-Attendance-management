...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main5Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        ...
                        break;
                    case R.id.developer:
                        Intent intent2 = new Intent(Main5Activity.this,developer.class);
                        intent2.putExtra("emailid",emailid);
                        startActivity(intent2);
                        //Toast.makeText(Main3Activity.this, "My Cart",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.mycart:
                        Intent intent3 = new Intent(Main5Activity.this,MainActivity.class);
        ...
        final String[] semester = { "CSE2101", "CSE2102", "CSE2103", "CSE2104","CSE2105","CS2106","CSE2107","CSE2108"};
