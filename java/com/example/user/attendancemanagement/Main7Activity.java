...
public class Main7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main7Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        Intent intent1 = new Intent(Main7Activity.this,Main2Activity.class);
                        ...
                        break;
                    case R.id.developer:
                        Intent intent3 = new Intent(Main7Activity.this,developer.class);
        ...
        final String[] semester = { "CSE3101", "CSE3102", "CSE3103", "CSE3104","CSE3105","CSE3106","CSE3107","CSE3108"};
