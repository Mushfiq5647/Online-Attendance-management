...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main6Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        Intent intent1 = new Intent(Main6Activity.this,Main2Activity.class);
                        ...
                        break;
                    case R.id.developer:
                        Intent intent3 = new Intent(Main6Activity.this,developer.class);
        ...
        final String[] semester = { "CSE2201", "CSE2202", "CSE2203", "CSE2204","CSE2205","CS2206","CSE2207","CSE2208"};
