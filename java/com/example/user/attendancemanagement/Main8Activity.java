...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main8Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        Intent intent1 = new Intent(Main8Activity.this,Main2Activity.class);
                        ...
                        break;
                    case R.id.developer:
                        Intent intent3 = new Intent(Main8Activity.this,developer.class);
                        intent3.putExtra("emailid",emailid);
                        startActivity(intent3);
                        //Toast.makeText(Main3Activity.this, "My Cart",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.mycart:
                        Intent intent2 = new Intent(Main8Activity.this,MainActivity.class);
        ...
        final String[] semester = { "CSE3201", "CSE3202", "CSE3203", "CSE3204","CSE3205","CS3206","CSE3207","CSE3208"};
