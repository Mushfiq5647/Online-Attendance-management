...
public class Main10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.account:
                        ...
                        Intent intent = new Intent(Main10Activity.this,Profile.class);
                    ...
                    case R.id.settings:
                        Intent intent1 = new Intent(Main10Activity.this,Main2Activity.class);
                        ...
                        break;
                    case R.id.developer:
                        Intent intent3 = new Intent(Main10Activity.this,developer.class);
                        intent3.putExtra("emailid",emailid);
                        startActivity(intent3);
                        //Toast.makeText(Main3Activity.this, "My Cart",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.mycart:
                        Intent intent2 = new Intent(Main10Activity.this,MainActivity.class);
        ...
        final String[] semester = { "CSE4201", "CSE4202", "CSE4203", "CSE4204","CSE4205","CSE4206","CSE4207","CSE4208"};
